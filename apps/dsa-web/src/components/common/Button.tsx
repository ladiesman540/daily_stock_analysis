...
const BUTTON_VARIANT_STYLES = {
  primary: 'border border-cyan/20 bg-primary-gradient text-primary-foreground shadow-soft-card hover:brightness-105',
  secondary: 'border border-border/80 bg-card text-foreground shadow-soft-card hover:bg-hover',
  ...
  outline: 'border border-cyan/25 bg-card/80 text-cyan hover:bg-cyan/10',
  ghost: 'border border-transparent bg-transparent text-secondary-text hover:bg-hover hover:text-foreground',
  gradient: 'border border-cyan/20 bg-primary-gradient text-primary-foreground shadow-soft-card hover:brightness-105',
...
export const Button: React.FC<ButtonProps> = ({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex cursor-pointer items-center justify-center gap-2 whitespace-nowrap font-medium transition-all duration-200 active:translate-y-px',
