...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "AGENT_LITELLM_MODEL": {
        "title": "Agent Primary Model (Legacy)",
        "description": "Legacy Agent-only primary model. Use AGENT_REASONING_MODEL for final analyst reasoning and AGENT_DATA_MODEL for cheaper data preparation.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_REASONING_MODEL": {
        "title": "Thoughtful Analyst Model",
        "description": "Primary model for final analyst reasoning, chat synthesis, and research conclusions. For your target setup, use openai/gpt-5.5 here when your account supports that model ID.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "AGENT_DATA_MODEL": {
        "title": "Data Gathering Model",
        "description": "Cheaper model for planning, extraction, tagging, and input preparation. When empty, it inherits the primary model.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ALPHA_VANTAGE_API_KEY": {
        ...
        "description": "Optional Alpha Vantage key for market news and sentiment before generic web search.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "POLYGON_API_KEY": {
        "title": "Massive / Polygon API Key",
        "description": "Optional Massive, formerly Polygon.io, key for US stock/ETF bars, options snapshots, Greeks, open interest, and gamma maps.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "MASSIVE_API_KEY": {
        ...
        "description": "Preferred key name for Massive market data. POLYGON_API_KEY is also accepted for compatibility.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "MASSIVE_API_BASE_URL": {
        "title": "Massive API Base URL",
        "description": "Massive REST base URL. Default is https://api.massive.com.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TRADIER_ACCESS_TOKEN": {
        "title": "Tradier Access Token",
        "description": "Optional Tradier bearer token for US options chains and Greeks when Polygon is unavailable.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "POSITIONING_OPTIONS_PROVIDER_PRIORITY": {
        "title": "Positioning Options Provider Priority",
        "description": "Comma-separated options-chain provider order. Supported values: polygon,tradier,yfinance.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "polygon,tradier,yfinance",
        "options": [],
        "validation": {},
        "display_order": 57,
    },
    "POSITIONING_USE_YFINANCE_OPTIONS": {
        "title": "Positioning yfinance Fallback",
        "description": "Allow delayed yfinance options chains as a free fallback when paid options providers are not configured.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SEC_USER_AGENT": {
        ...
        "description": "User-Agent header for SEC EDGAR API calls. SEC expects automated callers to identify themselves.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "daily-stock-analysis/1.0 contact@example.com",
        "options": [],
        "validation": {},
        "display_order": 59,
    },
    "MARKET_INTEL_ALLOW_GENERIC_SEARCH": {
        "title": "Market Intel Generic Search",
        "description": "Allow the market-intel layer to use configured generic web-search providers after official/typed sources.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "MARKET_INTEL_ALLOW_PUBLIC_SEARXNG": {
        "title": "Market Intel Public SearXNG",
        "description": "Allow public SearXNG instances as a last-resort analyst evidence source. Default false because public instances are often rate-limited or bot-blocked.",
        "category": "data_source",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OPENAI_CODEX_AUTH_ENABLED": {
        "title": "Use ChatGPT / Codex Login",
        "description": "Use the local Codex ChatGPT sign-in token for OpenAI model calls instead of an sk- API key. The token remains server-side and is read from the Codex auth file.",
        "category": "ai_model",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "OPENAI_CODEX_AUTH_PATH": {
        ...
        "description": "Path to the local Codex auth.json file used by the ChatGPT sign-in bridge.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OPENAI_CODEX_CLI_PATH": {
        ...
        "description": "Path to the Codex CLI used to check or refresh local ChatGPT sign-in status.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ANTHROPIC_MODEL": {
        ...
        "description": "Claude model name, for example claude-3-5-sonnet-20241022.",
        "category": "ai_model",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "ANTHROPIC_TEMPERATURE": {
        ...
        "description": "Temperature in the range [0.0, 1.0].",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "ANTHROPIC_MAX_TOKENS": {
        ...
        "description": "Maximum response tokens for Anthropic API calls. Default: 8192.",
        "category": "ai_model",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
